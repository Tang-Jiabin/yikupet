...
public class PayServiceImpl
    ...
    public String tenPayCallback(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("SUCCESS".equalsIgnoreCase((String) params.get("result_code"))) {
            ...
            /* 105 */
            Integer hospitalId = (Integer) map.get("hi");
    ...
    private void callbackUpdate(Map map) {
        /* 133 */
        PetHospitalInfo hospitalInfo = this.hospitalInfoRepository.findByHospitalId((Integer) map.get("hospitalId"));
        /* 134 */
        if (hospitalInfo != null) {
            ...
            /* 137 */
            Integer ratio = hospitalInfo.getRebateRatio();

            /* 139 */
            if (ratio == null) {
                /* 140 */
                ratio = Integer.valueOf(10);
            }

            /* 143 */
            Double realAmount = Double.valueOf((String) map.get("realAmount"));
            /* 144 */
            Double div = DoubleUtil.div(realAmount, Double.valueOf(100.0D));
            /* 145 */
            Double money = DoubleUtil.mul(div, Double.valueOf(ratio.intValue()));

            /* 147 */
            hospitalAccount.setHospitalId(hospitalInfo.getHospitalId());
            /* 148 */
            hospitalAccount.setMoney(money);
            /* 149 */
            hospitalAccount.setType(Integer.valueOf(1));
            /* 150 */
            hospitalAccount.setDate(new Date());
            /* 151 */
            hospitalAccount.setSource("邀请码");
            /* 152 */
            hospitalAccount.setRatio(ratio);
            /* 153 */
            hospitalAccount.setState(Integer.valueOf(1));
            /* 154 */
            this.hospitalAccountRepository.save(hospitalAccount);
        }
        ...
        /* 159 */
        insurancePolicy.setInsuranceStatus(Integer.valueOf(2));
        /* 160 */
        ...
        /* 162 */
        animal.setInsuranceStatus(Integer.valueOf(2));
        /* 163 */
