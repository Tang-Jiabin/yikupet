...
public class PetHospitalAccount {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PetHospitalAccount)) return false;
        PetHospitalAccount other = (PetHospitalAccount) o;
        ...
        Object this$hospitalId = getHospitalId();
        Object other$hospitalId = other.getHospitalId();
        if (this$hospitalId == null ? other$hospitalId != null : !this$hospitalId.equals(other$hospitalId))
            return false;
        ...
        Object this$withdrawalId = getWithdrawalId();
        Object other$withdrawalId = other.getWithdrawalId();
        return this$withdrawalId == null ? other$withdrawalId == null : this$withdrawalId.equals(other$withdrawalId);
    }

    protected boolean canEqual(Object other) {
        return other instanceof PetHospitalAccount;
    }
    ...
    public int hashCode() {
        ...
        Object $hospitalId = getHospitalId();
        result = result * 59 + ($hospitalId == null ? 43 : $hospitalId.hashCode());
        ...
        Object $withdrawalId = getWithdrawalId();
        result = result * 59 + ($withdrawalId == null ? 43 : $withdrawalId.hashCode());
        return result;
    }

    public String toString() {
        return "PetHospitalAccount(accountId=" + getAccountId() + ", hospitalId=" + getHospitalId() + ", money=" + getMoney() + ", type=" + getType() + ", date=" + getDate() + ", source=" + getSource() + ", ratio=" + getRatio() + ", state=" + getState() + ", withdrawalId=" + getWithdrawalId() + ")";
    }
