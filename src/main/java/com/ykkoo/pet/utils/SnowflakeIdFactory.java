...
public class SnowflakeIdFactory {
    ...
    private static SnowflakeIdFactory snowflakeIdFactory;

    public synchronized static SnowflakeIdFactory getInstance(long workerId, long datacenterId) {
        if (snowflakeIdFactory == null){
            snowflakeIdFactory = new SnowflakeIdFactory(workerId,datacenterId);
        }
    ...
    public static int getWorkerId() {
        ...
        if (mBeanServer == null) {
            log.error("没有发现JVM中关联的MBeanServer.");
            return workerId;
        }
...
//                    + mBeanServer.getDefaultDomain() + " 中的对象名称.");
            log.error("没有发现JVM中关联的MBeanServer : "+ mBeanServer.getDefaultDomain() + " 中的对象名称.");
            return workerId;
        }
        try {
