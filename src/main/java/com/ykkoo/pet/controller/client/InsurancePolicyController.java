...
/*     */   {
/*  34 */     this.insurancePolicyService = insurancePolicyService;this.request = request;this.fileService = fileService;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  47 */     String ip = com.ykkoo.pet.utils.IPUtil.getIp(this.request);
/*  48 */     insurancePolicy.setIp(ip);
/*  49 */     KVResult result = this.insurancePolicyService.createInsurancePolicy(insurancePolicy, userId);
/*  50 */     return ServerResponse.createMessage(result);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   public ServerResponse getInsurancePolicyPage(@ApiParam("页码 (从0开始)") @RequestParam(required=false, defaultValue="0") Integer page, @ApiParam("保险状态 1-没有卡 2-未生效 3-保障中 4-已过期") @RequestParam(required=false, defaultValue="0") Integer insuranceStatus, @ApiParam("保险类型 1-汪保 2-喵保") @RequestParam(required=false, defaultValue="0") Integer insuranceType, @ApiParam("宠物Id") @RequestParam(required=false, defaultValue="0") Integer animalId, @ApiIgnore @RequestAttribute Integer userId)
/*     */   {
/*  61 */     KVResult result = this.insurancePolicyService.getInsurancePolicyPage(page, insuranceStatus, insuranceType, animalId, userId, null);
/*  62 */     return ServerResponse.createMessage(result);
/*     */   }
/*     */   
/*     */   @Authorization
/*     */   @ApiOperation("保单详情")
...
/*  69 */     KVResult result = this.insurancePolicyService.getInsurancePolicyDetails(insurancePolicyId, userId, null);
/*  70 */     return ServerResponse.createMessage(result);
/*     */   }
/*     */   
/*     */   @Authorization
/*     */   @ApiOperation("申请理赔")
...
/*  77 */     KVResult result = this.insurancePolicyService.applyClaims(insurancePolicyId, userId);
/*  78 */     return ServerResponse.createMessage(result);
/*     */   }
/*     */   
/*     */   @Authorization
/*     */   @ApiOperation("理赔详情")
...
/*  85 */     KVResult result = this.insurancePolicyService.getCompensateDetails(compensateId, userId);
/*  86 */     return ServerResponse.createMessage(result);
/*     */   }
/*     */   
/*     */   @Authorization
/*     */   @ApiOperation("上传理赔凭证")
...
/*  93 */     KVResult result = this.insurancePolicyService.uploadClaimsVoucher(claimsVoucherDTO, userId);
/*  94 */     return ServerResponse.createMessage(result);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   public ServerResponse getCompensatePage(@ApiParam("页码") @RequestParam(required=false, defaultValue="0") Integer page, @ApiParam("条数") @RequestParam(required=false, defaultValue="10") Integer size, @ApiParam("理赔状态 1-未申请 2-待提交 3-审核中 4-理赔中 5-已结案 ") @RequestParam(required=false, defaultValue="0") Integer claimStatus, @ApiIgnore @RequestAttribute Integer userId)
/*     */   {
/* 105 */     KVResult result = this.insurancePolicyService.getCompensatePage(page, size, claimStatus, "", userId, null);
/* 106 */     return ServerResponse.createMessage(result.getKey().intValue(), result.getVal());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 116 */     KVResult result = this.insurancePolicyService.updateCompensateInfo(compensateId, claimStatus, userId);
/* 117 */     return ServerResponse.createMessage(result.getKey().intValue(), result.getVal());
/*     */   }
/*     */   
/*     */   @Authorization
/*     */   @ApiOperation("更新")
...
/* 124 */     KVResult result = this.fileService.update(fileUpdateDTO, userId);
/* 125 */     return ServerResponse.createMessage(result.getKey().intValue(), result.getVal());
/*     */   }
/*     */ }
