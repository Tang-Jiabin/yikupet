...
/*    */   {
/* 28 */     this.insurancePolicyService = insurancePolicyService;
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/*    */   public ServerResponse getInsurancePolicyPage(@ApiParam("页码 (从0开始)") @RequestParam(required=false, defaultValue="0") Integer page, @ApiParam("保险状态 1-审核未通过 2-未生效 3-保障中 4-已过期") @RequestParam(required=false, defaultValue="0") Integer insuranceStatus, @ApiParam("保险类型 1-汪保 2-喵保") @RequestParam(required=false, defaultValue="0") Integer insuranceType, @ApiParam("宠物Id") @RequestParam(required=false, defaultValue="0") Integer animalId, @ApiIgnore @RequestAttribute Integer adminId)
/*    */   {
/* 42 */     KVResult result = this.insurancePolicyService.getInsurancePolicyPage(page, insuranceStatus, insuranceType, animalId, null, adminId);
/* 43 */     return ServerResponse.createMessage(result);
/*    */   }
/*    */   
/*    */   @AdminAuthorization
/*    */   @ApiOperation("保单详情")
...
/* 50 */     KVResult result = this.insurancePolicyService.getInsurancePolicyDetails(insurancePolicyId, null, adminId);
/* 51 */     return ServerResponse.createMessage(result);
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/*    */   {
/* 64 */     KVResult result = this.insurancePolicyService.getCompensatePage(page, size, claimStatus, phone, userId, adminId);
/* 65 */     return ServerResponse.createMessage(result.getKey().intValue(), result.getVal());
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/*    */   {
/* 77 */     KVResult result = this.insurancePolicyService.updateCompensateInfo(compensateId, claimStatus, auditStatus, auditExplain, adminId);
/* 78 */     return ServerResponse.createMessage(result.getKey().intValue(), result.getVal());
/*    */   }
/*    */ }
